...
- Различия на отдельных переходах воронки показаны описательно, без отдельных статистических проверок.
- Результаты относятся к периоду наблюдения. Данных для оценки долгосрочного эффекта и изменения выручки нет.
